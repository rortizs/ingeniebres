...
class ControladorVentas{
	...
	static public function ctrEditarVenta(){
		...
		if(isset($_POST["editarVenta"])){
			...
			/* validar si se reciben prodictos editados */
			...
			if($cambioProducto){
				...
				/* Actualizar las comprar del cliente se resta el stock y se aumenta las ventas del producto */
	...
	static public function ctrEliminarVenta(){
		...
		if(isset($_GET["idVenta"])){
			...
			/* cambiar fecha de ultima compra*/
			...
			/* aplicar formatos a productos y clientes*/
