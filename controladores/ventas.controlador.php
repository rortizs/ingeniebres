	...
	static public function ctrCrearVenta(){
		...
		if(isset($_POST["nuevaVenta"])){
			...
			if($_POST["listaProductos"] == ""){
				...
				swal({
					  type: "error",
					  title: "Productos son necesarios para efectuar una venta",
			...
			if($respuesta == "ok"){
				...
				swal({
					  type: "success",
					  title: "La venta se ha guardado de manera exitosa",
					  showConfirmButton: true,
					  confirmButtonText: "Cerrar"
					  }).then(function(result){
								if (result.value) {
	...
	static public function ctrEditarVenta(){
		...
		if(isset($_POST["editarVenta"])){
			...
			if($respuesta == "ok"){
				...
				swal({
					  type: "success",
					  title: "La venta se ha actualizado de manera exitosa",
					  showConfirmButton: true,
					  confirmButtonText: "Cerrar"
					  }).then((result) => {
								if (result.value) {
	...
	static public function ctrEliminarVenta(){
		...
		if(isset($_GET["idVenta"])){
			...
			if($respuesta == "ok"){
				...
				swal({
					  type: "success",
					  title: "La venta se ha eliminado de manera exitosa",
					  showConfirmButton: true,
					  confirmButtonText: "Cerrar"
					  }).then(function(result){
								if (result.value) {
